      ...
      <main className="min-h-[calc(100vh-130px)] bg-purplebg text-textdark">
        <div className="mx-auto w-full max-w-6xl space-y-8 px-6 py-[30px]">
          <header className="space-y-2">
            <h1 className="pt-[45px] text-left text-3xl font-semibold text-primary">Admin · Reports</h1>
            <p className="text-base text-textdark/80">
              Analyse platform performance, engagement, and learning outcomes. Reporting widgets will live here soon.
            </p>
          </header>
          <section className="rounded-md bg-white p-6 shadow-sm text-sm text-textdark/70">
            <p>
              Reporting dashboards are being designed. Use this placeholder to capture requirements for adoption,
              completion, and outcome metrics.
            </p>
          </section>
        </div>
      </main>
